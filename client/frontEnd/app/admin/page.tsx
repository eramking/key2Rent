...
import { getCurrentUser, getToken } from "../API/authService"
  ...
  useEffect(() => {
    async function verifyAdminAccess() {
      try {
        ...
        const response = await fetch('http://localhost:5000/api/users/admin/verify', {
          headers: {
        ...
        setError('Unable to verify admin access. Redirecting to dashboard...')
        setTimeout(() => {
          router.push('/dashboard')
        }, 2000)
      }
